...
const vietnamGoldPrices = [
  { type: 'SJC 1L, 10L, 1KG', buy: '11,850', sell: '12,050' },
  { type: 'SJC 5 chỉ', buy: '11,845', sell: '12,045' },
  { type: 'SJC 1 chỉ, 2 chỉ', buy: '11,838', sell: '12,038' },
  { type: 'Nhẫn trơn 9999', buy: '11,420', sell: '11,680' },
  { type: 'Nữ trang 99.99%', buy: '11,310', sell: '11,570' },
  { type: 'Nữ trang 75%', buy: '8,240', sell: '8,940' },
];
        ...
        <div className="grid gap-5 xl:grid-cols-2">
          <section className="border-border/70 bg-white/88 rounded-[2rem] border px-5 py-5 shadow-[0_24px_65px_-42px_rgba(15,23,42,0.45)] backdrop-blur md:px-6 md:py-6">
            ...
            <div className="mt-5 overflow-hidden rounded-[1.5rem] border border-[#d8c8a6]/80">
              <div className="bg-[#f4e6bd] grid grid-cols-[minmax(0,1.6fr)_0.8fr_0.8fr] gap-3 px-4 py-3 text-sm font-semibold">
                <span>Type</span>
                <span className="text-right">Buy</span>
                <span className="text-right">Sell</span>
              </div>
              <div className="divide-y divide-[#eee4cf]">
                {vietnamGoldPrices.map((item) => (
                  <div
                    key={item.type}
                    className="grid grid-cols-[minmax(0,1.6fr)_0.8fr_0.8fr] gap-3 px-4 py-4 text-sm transition odd:bg-white even:bg-[#fffaf0]"
                  >
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              <div className="bg-[#f7f1e4] rounded-[1.5rem] px-4 py-4">
                ...
                <p className="mt-2 text-2xl font-semibold tracking-tight">+200</p>
          ...
          <section className="flex flex-col gap-5">
            ...
            <div className="border-border/70 bg-[#f4d98f] rounded-[2rem] border border-[#e2c16b] px-5 py-5 shadow-[0_24px_65px_-42px_rgba(128,87,17,0.45)] md:px-6 md:py-6">
              ...
              <div className="mt-4 flex items-center gap-2 text-sm text-[#5f4512]">
                ...
                Updated with the same reference window as the local gold board.
              </div>
            </div>
          </section>
        </div>
